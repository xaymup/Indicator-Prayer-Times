...
#       MA 02110-1301, USA.
#
#       Mohamed Alaa: I've Done some edits in the code in order to fix some bugs in
...
class Prayertime(object):
    ...
    def report(self):
        ...
        print 'Fajr Time is    ' , self.fajr_time()
        print 'Shrouk Time is  ' ,self.shrouk_time()
        print 'Zuhr  Time is   ' ,self.zuhr_time()
        print 'Asr Time is     ' ,self.asr_time()
        print 'Maghrib Time is ' ,self.maghrib_time()
        print 'Ishaa Time is   ' ,self.isha_time()
...
if __name__=="__main__":
    ...
    pt=Prayertime(21.4, 39.8, 2, 2012, 10, 31, Calendar.EgyptianGeneralAuthorityOfSurvey, Mazhab.Default, Season.Winter)
    print pt.get_qibla();
